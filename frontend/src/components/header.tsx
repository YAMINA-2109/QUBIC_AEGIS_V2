      ...
      <div className="flex items-center gap-4">
        ...
        {defconStatus && (
          <div className="flex items-center gap-2 border-r border-border pr-4">
            <Badge className={`${getDEFCONColor(defconStatus.defcon_level)} bg-transparent border ${defconStatus.defcon_level <= 2 ? "border-destructive" : "border-primary/30"} px-2 py-1 font-mono text-xs`}>
        ...
        <Badge className={`bg-primary text-primary-foreground px-3 py-1 border border-primary ${isConnected ? "cyber-glow" : ""}`}>
          <span className={`mr-2 inline-block h-2 w-2 rounded-full ${isConnected ? "bg-primary-foreground animate-pulse" : "bg-red-500"}`} />
